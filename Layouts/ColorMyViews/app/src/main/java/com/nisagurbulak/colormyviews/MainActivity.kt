package com.nisagurbulak.colormyviews
...
import com.nisagurbulak.colormyviews.databinding.ActivityMainBinding
    ...
    private fun setListeners() {
        val clickableViews : List<View> =
            listOf(binding.boxOneText,binding.boxTwoText,binding.boxThreeText,binding.boxFourText,binding.boxFiveText
                ,binding.constraintLayout,binding.redButton,binding.greenButton,binding.yellowButton)
